...
public class University {
  ...
  public static void main(String[] args) throws InvalidGPAException {
    ...
    do {
      ...
      /*
       * details about the group students
       */
      System.out.printf("\n\n\n| %-35s | %-20s | %-10s | %-30s ", "Name: Abdullah Mazen Alaql", "UQU ID : 443005948",
          "Group: 6", "Email: s443005948@st.uqu.edu.sa");
      System.out.println(
          "\n_______________________________________________________________________________________________________________");

      System.out.printf("\n| %-35s | %-20s |  %-10s |  %-30s ", "Name: Abdulrahman Mohammed Bumandr",
          "UQU ID : 443011895", "Group: 6", "Email: s443011895@st.uqu.edu.sa");
